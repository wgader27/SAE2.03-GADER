...
if (isset($_REQUEST['todo'])) {
    ...
    switch ($todo) {
        ...
        case 'readusers':
            $data = readUsersController();
            break;

        case 'readuserbyid':
            $data = readUserDetailController();
            break;
        ...
        case 'getbookmarks':
            $data = getBookmarksController();
            break;

        case 'isbookmarked':
            $data = isBookmarkedController();
            break;

        case 'addbookmark':
            $data = addBookmarkController();
            break;

        case 'deletebookmark':
            $data = deleteBookmarkController();
            break;
